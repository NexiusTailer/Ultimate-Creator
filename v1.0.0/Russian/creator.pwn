...
#define MAP_DOES_NOT_EXIST_ERROR		"Вам необходимо создать какую-либо карту для её сохранения!"
...
#define INCORRECT_OBJECT_ID_ERROR		"Введите правильный ID или название модели объекта!"
...
#define INCORRECT_VEHICLE_ID_ERROR		"Введите правильный ID или название модели транспорта!"
...
#define INCORRECT_PICKUP_ID_ERROR		"Введите правильный ID или название модели пикапа!"
...
#define TEXTURE_RESET					"Текстура объекта %d сброшена (слой %d)"
...
#define TEXTURE_CHANGED					"Текстура объекта %d изменена на %d (слой %d)"
...
#define OBJECT_COLOR_CHANGED			"Вы установили цвет %d объекту %d"
#define INCORRECT_LAYER_ID_ERROR		"Введите правильный ID слоя (materialindex)!"
#define OBJECT_TEXT_RESET				"Текст объекта %d сброшен (слой %d)"
#define INCORRECT_OBJECT_TEXT_ERROR		"Введите текст, который будет отображаться на объекте!"
#define OBJECT_TEXT_CHANGED				"Текст объекта %d изменён"
#define OBJECT_TEXT_SIZE_CHANGED		"Размер текста объекта %d изменён на %d"
...
#define FONT_CHANGED					"Шрифт текста объекта %d изменён"
...
#define FONT_SIZE_CHANGED				"Размер шрифта текста объекта %d изменён на %d"
#define OBJECT_TEXT_BOLD_CHANGED		"Жирность текста объекта %d установлена на %d"
...
#define FONT_COLOR_CHANGED				"Вы установили цвет %d тексту объекта %d"
...
#define BACK_COLOR_CHANGED				"Вы установили цвет %d фону объекта %d"
#define ALIGNMENT_CHANGED				"Выравнивание текста объекта %d изменено на %d"
#define INCORRECT_COORD_X_ERROR			"Введите правильную координату X!"
#define OBJECT_TELEPORTED_TO_X			"Вы переместили объект %d на координату X: %.4f"
#define INCORRECT_COORD_Y_ERROR			"Введите правильную координату Y!"
#define OBJECT_TELEPORTED_TO_Y			"Вы переместили объект %d на координату Y: %.4f"
#define INCORRECT_COORD_Z_ERROR			"Введите правильную координату Z!"
#define OBJECT_TELEPORTED_TO_Z			"Вы переместили объект %d на координату Z: %.4f"
#define INCORRECT_ROT_X_ERROR			"Введите правильную координату вращения X!"
#define OBJECT_TELEPORTED_TO_ROT_X		"Вы переместили объект %d на координату вращения X: %.4f"
#define INCORRECT_ROT_Y_ERROR			"Введите правильную координату вращения Y!"
#define OBJECT_TELEPORTED_TO_ROT_Y		"Вы переместили объект %d на координату вращения Y: %.4f"
#define INCORRECT_ROT_Z_ERROR			"Введите правильную координату вращения Z!"
#define OBJECT_TELEPORTED_TO_ROT_Z		"Вы переместили объект %d на координату вращения Z: %.4f"
...
#define VEHICLE_TELEPORTED_TO_X			"Вы переместили транспорт %d на координату X: %.4f"
#define VEHICLE_TELEPORTED_TO_Y			"Вы переместили транспорт %d на координату Y: %.4f"
#define VEHICLE_TELEPORTED_TO_Z			"Вы переместили транспорт %d на координату Z: %.4f"
#define VEHICLE_TELEPORTED_TO_ROT_Z		"Вы переместили транспорт %d на координату вращения Z: %.4f"
#define INCORRECT_RESPAWN_TIME_ERROR	"Введите правильное время респавна!"
#define RESPAWN_TIME_CHANGED			"Вы установили время респавна %d мс транспорту %d"
#define INCORRECT_COLOR_1_ERROR			"Введите правильный цвет 1!"
#define COLOR_1_CHANGED					"Вы установили транспорту %d цвет 1: %d"
#define INCORRECT_COLOR_2_ERROR			"Введите правильный цвет 2!"
#define COLOR_2_CHANGED					"Вы установили транспорту %d цвет 2: %d"
...
#define ACTOR_TELEPORTED_TO_X			"Вы переместили актёра %d на координату X: %.4f"
#define ACTOR_TELEPORTED_TO_Y			"Вы переместили актёра %d на координату Y: %.4f"
#define ACTOR_TELEPORTED_TO_Z			"Вы переместили актёра %d на координату Z: %.4f"
#define ACTOR_TELEPORTED_TO_ROT_Z		"Вы переместили актёра %d на координату вращения Z: %.4f"
...
#define PICKUP_TYPE_CHANGED				"Вы установили тип %d пикапу %d"
#define PICKUP_TELEPORTED_TO_X			"Вы переместили пикап %d на координату X: %.4f"
#define PICKUP_TELEPORTED_TO_Y			"Вы переместили пикап %d на координату Y: %.4f"
#define PICKUP_TELEPORTED_TO_Z			"Вы переместили пикап %d на координату Z: %.4f"
#define INCORRECT_VW_ERROR				"Введите правильный ID виртуального мира!"
#define PICKUP_VW_CHANGED				"Вы установили виртуальный мир %d пикапу %d"
...
#define CP_TELEPORTED_TO_X				"Вы переместили checkpoint %d на координату X: %.4f"
#define CP_TELEPORTED_TO_Y				"Вы переместили checkpoint %d на координату Y: %.4f"
#define INCORRECT_SIZE_ERROR			"Введите правильный размер!"
#define CP_SIZE_CHANGED					"Вы установили размер %.1f checkpoint'у %d"
...
#define RCP_TYPE_CHANGED				"Вы установили тип %d race checkpoint'у %d"
#define RCP_TELEPORTED_TO_X				"Вы переместили race checkpoint %d на координату X: %.4f"
#define RCP_TELEPORTED_TO_Y				"Вы переместили race checkpoint %d на координату Y: %.4f"
#define RCP_TELEPORTED_TO_Z				"Вы переместили race checkpoint %d на координату Z: %.4f"
#define INCORRECT_NEXTX_ERROR			"Введите правильную координату X следующей точки, на которую будет повёрнут указатель!"
#define RCP_NEXTX_CHANGED				"NextX для race checkpoint'а %d установлена на %.4f"
#define INCORRECT_NEXTY_ERROR			"Введите правильную координату Y следующей точки, на которую будет повёрнут указатель!"
#define RCP_NEXTY_CHANGED				"NextY для race checkpoint'а %d установлена на %.4f"
#define INCORRECT_NEXTZ_ERROR			"Введите правильную координату Z следующей точки, на которую будет повёрнут указатель!"
#define RCP_NEXTZ_CHANGED				"NextZ для race checkpoint'а %d установлена на %.4f"
#define RCP_SIZE_CHANGED				"Вы установили размер %.1f race checkpoint'у %d"
...
#define MAPICON_TELEPORTED_TO_X			"Вы переместили map иконку %d на координату X: %.4f"
#define MAPICON_TELEPORTED_TO_Y			"Вы переместили map иконку %d на координату Y: %.4f"
#define MAPICON_TELEPORTED_TO_Z			"Вы переместили map иконку %d на координату Z: %.4f"
#define INCORRECT_ICON_COLOR_ERROR		"Введите правильный цвет map иконки!"
#define MAPICON_COLOR_CHANGED			"Вы установили цвет %d map иконке %d"
#define MAPICON_STYLE_CHANGED			"Вы установили стиль отображения %d map иконке %d"
...
#define GANGZONE_MINX_CHANGED			"Вы установили gang зоне %d координату min X: %.4f"
#define INCORRECT_COORD_MINY_ERROR		"Введите правильную координату min Y!"
#define GANGZONE_MINY_CHANGED			"Вы установили gang зоне %d координату min Y: %.4f"
#define INCORRECT_COORD_MAXX_ERROR		"Введите правильную координату max X!"
#define GANGZONE_MAXX_CHANGED			"Вы установили gang зоне %d координату max X: %.4f"
#define INCORRECT_COORD_MAXY_ERROR		"Введите правильную координату max Y!"
#define GANGZONE_MAXY_CHANGED			"Вы установили gang зоне %d координату max Y: %.4f"
#define INCORRECT_ZONE_COLOR_ERROR		"Введите правильный цвет gang зоны!"
#define GANGZONE_COLOR_CHANGED			"Вы установили цвет %d gang зоне %d"
...
#define LABEL_TEXT_CHANGED				"Текст 3D текста %d изменён"
#define INCORRECT_LABEL_COLOR_ERROR		"Введите правильный цвет 3D текста!"
#define LABEL_COLOR_CHANGED				"Вы установили цвет %d 3D тексту %d"
#define LABEL_TELEPORTED_TO_X			"Вы переместили 3D текст %d на координату X: %.4f"
#define LABEL_TELEPORTED_TO_Y			"Вы переместили 3D текст %d на координату Y: %.4f"
#define LABEL_TELEPORTED_TO_Z			"Вы переместили 3D текст %d на координату Z: %.4f"
#define INCORRECT_LABEL_DD_ERROR		"Введите правильную дистанцию прорисовки!"
#define LABEL_DD_CHANGED				"Вы установили дистанцию прорисовки %.4f 3D тексту %d"
#define LABEL_VW_CHANGED				"Вы установили виртуальный мир %d 3D тексту %d"
#define LABEL_LOS_ENABLED				"Видимость сквозь стены включена"
#define LABEL_LOS_DISABLED				"Видимость сквозь стены отключена"
...
#define WEATHER_ID_CHANGED				"Погода id %d установлена"
#define TIME_CHANGED					"Время %d:00 установлено"
#define INCORRECT_GRAVITY_ERROR			"Введите правильное значение гравитации!"
#define GRAVITY_CHANGED					"Значение гравитации %f установлено"
...
#define EDIT_TEXTURE					"Изменить текстуру"
#define EDIT_OBJECT_COLOR				"Изменить цвет объекта"
...
#define ENTER_RESPAWN_TIME				"Введите время респавна (мс), через которое будет появляться транспорт:"
#define RESPAWN_TIME_NOW				"Время сейчас: %d мс"
...
#define SELECT_ZONE						"Выделить gang зону"
...
#define EDIT_LON_IN_MSG					"%s вошёл в режим редактирования"
